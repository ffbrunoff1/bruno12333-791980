...
export default function Services() {
  ...
  // Variável para armazenar o componente do ícone ativo
      ...
      <div className="container-custom relative z-10">
        ...
        >
          {services.map((service, index ) => {
            const ServiceIcon = service.icon; // Define o ícone para o botão
            return (
              <motion.button
                key={index}
              ...
              >
                <ServiceIcon className={`w-8 h-8 mb-4 ${
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              <div className="flex items-center space-x-3 mb-6">
                <div className={`w-12 h-12 bg-${services[activeService].color}-500 rounded-xl flex items-center justify-center`}>
                  ...
                  <ActiveServiceIcon className="w-6 h-6 text-white" />
                </div>
                <div>
                ...
                return (
                  ...
                  >
                    <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-white/20 transition-colors duration-300">
                      <BenefitIcon className="w-8 h-8 text-accent-400" />
                    </div>
